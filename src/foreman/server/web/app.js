(function () {
  ...
  const I18N = {
    zh: {
      ...
      contextLoading: "正在加载上下文…", contextRestoreDegraded: "上下文恢复已降级。Foreman 已回退为原始已物化帧。",
      contextUsage: "上下文用量", contextStateCompacting: "压缩中", contextStateDegraded: "已降级", contextStateHealthy: "健康",
      contextSoftThreshold: "70% 软阈值", contextHardThreshold: "90% 硬阈值", contextUsed: "已使用", contextWindow: "窗口", contextTokens: "令牌",
      contextUsagePercent: "用量", contextSoftCompactIn: "距软压缩", contextHardCompactIn: "距硬压缩", contextMode: "模式",
      contextModeCheckpoint: "检查点", contextModeRawFrames: "原始帧", contextModeRawFramesDegraded: "原始帧（降级）",
      contextCompactNow: "立即压缩", contextCompactBusy: "正在压缩上下文…", contextCompactFailed: "上下文压缩失败。", contextCompacted: "上下文已压缩。", contextLatestUnchanged: "最新检查点未变更。",
      contextCopyCheckpointSummary: "复制检查点摘要", contextViewRawEvents: "查看原始事件", contextUnknown: "未知",
      contextRuntimeState: "运行状态", contextWorkspace: "工作区", contextCwd: "当前目录", contextWorktree: "工作树", contextBranch: "分支", contextBaseRef: "基线引用", contextHeadSha: "Head SHA",
      contextAgents: "子代理", contextAgent: "代理", contextNoActiveAgents: "尚未捕获活动代理。", contextStatusActive: "活动中", contextStatusCompleted: "已完成", contextStatusFailed: "失败", contextStatusIdle: "空闲", contextStatusRunning: "运行中",
      contextLatestCheckpoint: "最新检查点", contextId: "ID", contextTrigger: "触发方式", contextReason: "原因", contextMethod: "方法", contextBefore: "压缩前", contextAfter: "压缩后", contextReplacementItems: "替换历史项", contextStatus: "状态",
      contextNoCheckpoint: "尚无上下文检查点。Foreman 正在为此会话使用原始已物化帧。", contextNoCheckpointShort: "尚无上下文检查点。",
      contextLaneUsage: "通道用量", contextLane: "通道", contextLane7High: "通道 7 噪声较高；下次 PM 轮次前可能提前触发压缩。",
      contextEvidenceSummary: "证据摘要", contextChangedFiles: "变更文件", contextNoChangedFiles: "尚未捕获变更文件。", contextLastTests: "最近测试", contextNoTestResults: "尚未捕获测试结果。", contextNextSteps: "下一步", contextNoNextSteps: "尚未捕获下一步。", contextLastCommands: "最近命令", contextNoCommands: "尚未捕获命令。",
      contextCheckpointList: "检查点列表", contextCheckpointDetail: "检查点详情", contextSummary: "摘要", contextRuntime: "运行时", contextTokenUsage: "令牌用量", contextSourceCursor: "来源游标", contextWarnings: "警告", contextSelectCheckpoint: "选择一个检查点以查看已脱敏详情。",
      contextActivePreview: "当前上下文预览", contextFullPreview: "显示完整内容", contextFullPreviewLoading: "正在加载完整内容…", contextFullPreviewHelp: "完整内容仅在点击后读取和渲染。", contextFullPreviewLoaded: "正在显示完整内容。", contextPreviewOnly: "仅显示预览",
    ...
    en: {
      ...
      contextLoading: "Loading context...", contextRestoreDegraded: "Context restore degraded. Foreman fell back to raw materialized frames.",
      contextUsage: "Context Usage", contextStateCompacting: "compacting", contextStateDegraded: "degraded", contextStateHealthy: "healthy",
      contextSoftThreshold: "70% soft", contextHardThreshold: "90% hard", contextUsed: "Used", contextWindow: "Window", contextTokens: "tokens",
      contextUsagePercent: "Usage", contextSoftCompactIn: "Soft compact in", contextHardCompactIn: "Hard compact in", contextMode: "Mode",
      contextModeCheckpoint: "checkpoint", contextModeRawFrames: "raw frames", contextModeRawFramesDegraded: "raw frames (degraded)",
      contextCompactNow: "Compact Now", contextCompactBusy: "Context compacting...", contextCompactFailed: "Context compact failed.", contextCompacted: "Context compacted.", contextLatestUnchanged: "Latest checkpoint was not changed.",
      contextCopyCheckpointSummary: "Copy Checkpoint Summary", contextViewRawEvents: "View Raw Events", contextUnknown: "unknown",
      contextRuntimeState: "Runtime State", contextWorkspace: "Workspace", contextCwd: "CWD", contextWorktree: "Worktree", contextBranch: "Branch", contextBaseRef: "Base ref", contextHeadSha: "Head SHA",
      contextAgents: "Agents", contextAgent: "agent", contextNoActiveAgents: "No active agents captured yet.", contextStatusActive: "active", contextStatusCompleted: "completed", contextStatusFailed: "failed", contextStatusIdle: "idle", contextStatusRunning: "running",
      contextLatestCheckpoint: "Latest Checkpoint", contextId: "ID", contextTrigger: "Trigger", contextReason: "Reason", contextMethod: "Method", contextBefore: "Before", contextAfter: "After", contextReplacementItems: "Replacement history items", contextStatus: "Status",
      contextNoCheckpoint: "No context checkpoint yet. Foreman is using raw materialized frames for this session.", contextNoCheckpointShort: "No context checkpoint yet.",
      contextLaneUsage: "Lane Usage", contextLane: "Lane", contextLane7High: "Lane 7 noise is high; compact may be triggered before the next PM turn.",
      contextEvidenceSummary: "Evidence Summary", contextChangedFiles: "Changed Files", contextNoChangedFiles: "No changed files captured yet.", contextLastTests: "Last Tests", contextNoTestResults: "No test results captured yet.", contextNextSteps: "Next Steps", contextNoNextSteps: "No next steps captured yet.", contextLastCommands: "Last Commands", contextNoCommands: "No commands captured yet.",
      contextCheckpointList: "Checkpoint List", contextCheckpointDetail: "Checkpoint Detail", contextSummary: "Summary", contextRuntime: "Runtime", contextTokenUsage: "Token Usage", contextSourceCursor: "Source Cursor", contextWarnings: "Warnings", contextSelectCheckpoint: "Select a checkpoint to inspect sanitized detail.",
      contextActivePreview: "Active Context Preview", contextFullPreview: "Show full context", contextFullPreviewLoading: "Loading full context...", contextFullPreviewHelp: "Full content is fetched and rendered only after you request it.", contextFullPreviewLoaded: "Showing full context.", contextPreviewOnly: "Show preview only",
